...
const ICON_COMPONENTS: Record<string, IconType> = {
    AlertTriangle: TbAlertTriangle, TbBulb, Eye: TbEye, MessageCircle: TbMessage, ArrowDown: TbArrowDown, Theater: TbTheater, TbQuote, TbCode,
    TrendingDown: TbTrendingDown, TbTrendingUp, TbChartBar, Factory: TbBuildingFactory, Bot: TbRobot, Cog: TbSettings, TbTool, Hammer: TbHammer,
    TbWorld, Globe2: TbWorld, Map: TbMap, AlertCircle: TbAlertCircle, ArrowUp: TbArrowUp, ArrowRight: TbArrowRight, Clapperboard: TbMovie, TbVideo,
    Brain: TbBrain, Pill: TbPill, Hospital: TbBuildingHospital, Heart: TbHeart, Coins: TbCoins, TbCurrencyDollar, Gem: TbDiamond, Package: TbPackage, TbSpeakerphone, Bell: TbBell,
    ChevronRight: TbChevronRight, Droplet: TbDroplet, TbBolt, Flame: TbFlame, Target: TbTarget, Pin: TbPin, TbSparkles, Dna: TbDna, TbFileText, Trophy: TbTrophy,
    Stethoscope: TbStethoscope, TbCpu, Atom: TbAtom, CheckCircle: TbCircleCheck
}
