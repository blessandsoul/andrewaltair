"use strict";(()=>{var e={};e.id=6717,e.ids=[6717],e.modules={11185:e=>{e.exports=require("mongoose")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},52312:(e,t,i)=>{i.r(t),i.d(t,{originalPathname:()=>F,patchFetch:()=>G,requestAsyncStorage:()=>x,routeModule:()=>L,serverHooks:()=>E,staticGenerationAsyncStorage:()=>M});var o={};i.r(o),i.d(o,{default:()=>v});var r={};i.r(r),i.d(r,{GET:()=>R});var n=i(49303),a=i(88716),s=i(60670),l=i(55661);let c={projectTitle:"Vibe Coding",language:"ka",telegramContact:"https://t.me/andr3waltairchannel",categories:[{id:"intro",title:"შესავალი",icon:"\uD83C\uDFAF",articles:[{id:"what-is-vibe-coding",title:"რა არის Vibe Coding?",isFree:!0,content:`# რა არის Vibe Coding?
...
**სრული მონეტიზაციის სტრატეგია პრემიუმ ვერსიაში!**`}]}]};var p=i(11185),d=i.n(p);let u=process.env.MONGODB_URI;if(!u)throw Error("Please define the MONGODB_URI environment variable inside .env.local");let m=global.mongoose||{conn:null,promise:null};async function g(){if(m.conn)return m.conn;m.promise||(m.promise=d().connect(u,{bufferCommands:!1}).then(e=>e));try{m.conn=await m.promise}catch(e){throw m.promise=null,e}return m.conn}global.mongoose||(global.mongoose=m);let y=new p.Schema({fire:{type:Number,default:0},love:{type:Number,default:0},mindblown:{type:Number,default:0},applause:{type:Number,default:0},insightful:{type:Number,default:0}},{_id:!1}),h=new p.Schema({metaTitle:{type:String,maxlength:60},metaDescription:{type:String,maxlength:160},keywords:{type:String},canonicalUrl:{type:String},focusKeyword:{type:String},seoScore:{type:Number,min:0,max:100},ogImage:{type:String}},{_id:!1}),S=new p.Schema({name:{type:String,required:!0},avatar:{type:String},role:{type:String}},{_id:!1}),C=new p.Schema({icon:{type:String},title:{type:String},content:{type:String,required:!0},type:{type:String,enum:["intro","section","sarcasm","warning","tip","fact","opinion","cta","hashtags","prompt","author-comment"],default:"section"}},{_id:!1}),A=new p.Schema({horizontal:{type:String},vertical:{type:String}},{_id:!1}),b=new p.Schema({src:{type:String,required:!0},alt:{type:String},caption:{type:String}},{_id:!1}),f=new p.Schema({url:{type:String,required:!0},platform:{type:String,enum:["youtube","vimeo"],required:!0},videoId:{type:String},thumbnailUrl:{type:String}},{_id:!1}),I=new p.Schema({slug:{type:String,required:[!0,"Slug is required"],unique:!0,trim:!0},title:{type:String,required:[!0,"Title is required"],trim:!0},excerpt:{type:String,required:[!0,"Excerpt is required"],trim:!0},content:{type:String,default:""},rawContent:{type:String,default:""},coverImage:{type:String},coverImages:{type:A},gallery:{type:[b],default:[]},sections:{type:[C],default:[]},category:{type:String,required:[!0,"Category is required"],index:!0},tags:{type:[String],default:[]},author:{type:S,required:!0},publishedAt:{type:Date,default:Date.now},readingTime:{type:Number,default:5},views:{type:Number,default:0},comments:{type:Number,default:0},shares:{type:Number,default:0},reactions:{type:y,default:()=>({fire:0,love:0,mindblown:0,applause:0,insightful:0})},featured:{type:Boolean,default:!1},trending:{type:Boolean,default:!1},status:{type:String,enum:["draft","published","scheduled","archived"],default:"draft",index:!0},scheduledFor:{type:Date},order:{type:Number,default:0},seo:{type:h,default:()=>({})},videos:{type:[f],default:[]},relatedPosts:{type:[String],default:[]},numericId:{type:String,unique:!0,sparse:!0,index:!0}},{timestamps:!0});I.index({title:"text",excerpt:"text",content:"text",rawContent:"text",numericId:"text"});let P=d().models.Post||d().model("Post",I);async function v(){let e="https://andrewaltair.ge",t=[{url:e,lastModified:new Date,changeFrequency:"weekly",priority:1},{url:`${e}/blog`,lastModified:new Date,changeFrequency:"daily",priority:.9},{url:`${e}/encyclopedia/vibe-coding`,lastModified:new Date,changeFrequency:"daily",priority:.9},{url:`${e}/tools`,lastModified:new Date,changeFrequency:"weekly",priority:.8},{url:`${e}/videos`,lastModified:new Date,changeFrequency:"weekly",priority:.8},{url:`${e}/about`,lastModified:new Date,changeFrequency:"monthly",priority:.6},{url:`${e}/mystic`,lastModified:new Date,changeFrequency:"weekly",priority:.7},{url:`${e}/privacy`,lastModified:new Date,changeFrequency:"yearly",priority:.3},{url:`${e}/terms`,lastModified:new Date,changeFrequency:"yearly",priority:.3}],i=(function(){let e=[];return c.categories.forEach(t=>{e.push(...t.articles)}),e})().map(t=>({url:`${e}/encyclopedia/vibe-coding/${t.id}`,lastModified:new Date,changeFrequency:"weekly",priority:.8})),o=[];try{await g(),o=(await P.find({status:"published"}).select("slug updatedAt createdAt").lean()).map(t=>({url:`${e}/blog/${t.slug}`,lastModified:t.updatedAt||t.createdAt||new Date,changeFrequency:"weekly",priority:.8}))}catch(e){console.error("Sitemap: Error fetching blog posts:",e)}return[...t,...i,...o]}var w=i(60707);let D={...o},T=D.default,k=D.generateSitemaps;if("function"!=typeof T)throw Error('Default export is missing in "C:\\Users\\User\\Desktop\\GITHUB\\andrewaltair\\fresh\\src\\app\\sitemap.ts"');async function R(e,t){let i;let{__metadata_id__:o,...r}=t.params||{},n=k?await k():null;if(n&&null==(i=n.find(e=>{let t=e.id.toString();return(t+=".xml")===o})?.id))return new l.NextResponse("Not Found",{status:404});let a=await T({id:i}),s=(0,w.resolveRouteData)(a,"sitemap");return new l.NextResponse(s,{headers:{"Content-Type":"application/xml","Cache-Control":"public, max-age=0, must-revalidate"}})}let L=new n.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/sitemap.xml/route",pathname:"/sitemap.xml",filename:"sitemap",bundlePath:"app/sitemap.xml/route"},resolvedPagePath:"next-metadata-route-loader?page=%2Fsitemap.xml%2Froute&filePath=C%3A%5CUsers%5CUser%5CDesktop%5CGITHUB%5Candrewaltair%5Cfresh%5Csrc%5Capp%5Csitemap.ts&isDynamic=1!?__next_metadata_route__",nextConfigOutput:"standalone",userland:r}),{requestAsyncStorage:x,staticGenerationAsyncStorage:M,serverHooks:E}=L,F="/sitemap.xml/route";function G(){return(0,s.patchFetch)({serverHooks:E,staticGenerationAsyncStorage:M})}},60707:(e,t,i)=>{Object.defineProperty(t,"__esModule",{value:!0}),function(e,t){for(var i in t)Object.defineProperty(e,i,{enumerable:!0,get:t[i]})}(t,{resolveManifest:function(){return a},resolveRobots:function(){return r},resolveRouteData:function(){return s},resolveSitemap:function(){return n}});let o=i(91389);function r(e){let t="";for(let i of Array.isArray(e.rules)?e.rules:[e.rules]){for(let e of(0,o.resolveArray)(i.userAgent||["*"]))t+=`User-Agent: ${e}
...
`}),t}function n(e){let t=e.some(e=>Object.keys(e.alternates??{}).length>0),i="";for(let r of(i+='<?xml version="1.0" encoding="UTF-8"?>\n<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"',t?i+=' xmlns:xhtml="http://www.w3.org/1999/xhtml">\n':i+=">\n",e)){var o;i+=`<url>
<loc>${r.url}</loc>
`;let e=null==(o=r.alternates)?void 0:o.languages;if(e&&Object.keys(e).length)for(let t in e)i+=`<xhtml:link rel="alternate" hreflang="${t}" href="${e[t]}" />
`;if(r.lastModified){let e=r.lastModified instanceof Date?r.lastModified.toISOString():r.lastModified;i+=`<lastmod>${e}</lastmod>
`}r.changeFrequency&&(i+=`<changefreq>${r.changeFrequency}</changefreq>
`),"number"==typeof r.priority&&(i+=`<priority>${r.priority}</priority>
`),i+="</url>\n"}return i+"</urlset>\n"}function a(e){return JSON.stringify(e)}function s(e,t){return"robots"===t?r(e):"sitemap"===t?n(e):"manifest"===t?a(e):""}},91389:(e,t)=>{function i(e){return Array.isArray(e)?e:[e]}function o(e){if(null!=e)return i(e)}Object.defineProperty(t,"__esModule",{value:!0}),function(e,t){for(var i in t)Object.defineProperty(e,i,{enumerable:!0,get:t[i]})}(t,{resolveArray:function(){return i},resolveAsArrayOrUndefined:function(){return o}})}};var t=require("../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),o=t.X(0,[8948,2518],()=>i(52312));module.exports=o})();