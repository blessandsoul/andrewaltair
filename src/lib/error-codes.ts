export const ERROR_CODES = {
  ...
  PHONE_LEAD_FAILED: 'PHONE_LEAD_FAILED',
  ...
  FORUM_FETCH_FAILED: 'FORUM_FETCH_FAILED',
  FORUM_CREATE_FAILED: 'FORUM_CREATE_FAILED',
  FORUM_DELETE_FAILED: 'FORUM_DELETE_FAILED',
  FORUM_GENERATE_FAILED: 'FORUM_GENERATE_FAILED',
  FORUM_CRON_FAILED: 'FORUM_CRON_FAILED',

  // Workshop Room
  WORKSHOP_NOT_FOUND: 'WORKSHOP_NOT_FOUND',
  WORKSHOP_CREATE_FAILED: 'WORKSHOP_CREATE_FAILED',
  WORKSHOP_FETCH_FAILED: 'WORKSHOP_FETCH_FAILED',
  WORKSHOP_UPDATE_FAILED: 'WORKSHOP_UPDATE_FAILED',
  WORKSHOP_FORBIDDEN: 'WORKSHOP_FORBIDDEN',
  WORKSHOP_ROUND_CLOSED: 'WORKSHOP_ROUND_CLOSED',
  WORKSHOP_JOIN_FAILED: 'WORKSHOP_JOIN_FAILED',
  WORKSHOP_SUBMIT_FAILED: 'WORKSHOP_SUBMIT_FAILED',
