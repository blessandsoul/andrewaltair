...
export const brand = {
  // Core Identity
  name: "Andrew Altair",
  tagline: "AI ინოვატორი და კონტენტის შემქმნელი",
  ...
  bio: {
    ...
    short: "ვასწავლი, როგორ გამოიყენოთ ხელოვნური ინტელექტი რეალურ ცხოვრებაში — შემოსავლის ზრდისა და ბიზნესის ავტომატიზაციისთვის.",
    long: "ვასწავლი, როგორ გამოიყენოთ ხელოვნური ინტელექტი რეალურ ცხოვრებაში — შემოსავლის ზრდისთვის, ბიზნესის ავტომატიზაციისთვის და კონკურენტული უპირატესობისთვის.",
    philosophy: "ხელოვნური ინტელექტი (AI) მომავალი კი არა, აწმყოა. ვინც დღეს ისწავლის, ხვალ გაიმარჯვებს.",
    bullets: [
      "AI ბოტები და პრომპტების მარკეტფლეისი (პირველი საქართველოში)",
      "ყოველდღიური ვიდეოები და სტატიები AI-ს სამყაროზე",
      "კურსები: ნულიდან AI პროფესიონალამდე",
      "პირველი ქართული AI სააგენტოს, aiNOW-ის დამფუძნებელი",
      "The Centaur Method: AI-კონტენტის ავტორის კურსი",
      "AGENT: 88 AI-აგენტის საკუთარი სისტემა და trendingNOW სიგნალები"
    ]
  },
