...
import { TbMenu2, TbX, TbRocket, TbLock, TbSearch } from 'react-icons/tb';
import { useAuth } from '@/lib/auth';
import { AI_2026_DATA } from '@/data/ai2026Content';

export default function AI2026Sidebar() {
                ...
                <div className="p-5 border-b border-gray-100 flex-shrink-0">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="p-2 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-xl">
                            <TbRocket size={22} className="text-white" />
                        </div>
                        <div>
                            <h2 className="text-lg font-bold text-gray-900">AI 2026</h2>
                            <p className="text-xs text-gray-500">მომავლის გზამკვლევი</p>
                        </div>
                    </div>
