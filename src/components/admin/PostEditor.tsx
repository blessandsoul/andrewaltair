    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex justify-end gap-2 fixed bottom-0 right-0 p-4 bg-background border-t w-full z-50">
                <Button type="button" variant="outline" onClick={() => { alert('Cancel clicked!'); onCancel(); }}>Cancel</Button>
                <Button type="button" onClick={() => { alert('SAVE CLICKED!'); onSave(post); }}>Save</Button>
            </div>
        </div>
    )
}
