    ...
    return (
        <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden py-20">
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
                ...
                >
                    <span className="bg-gradient-to-r from-[#00f3ff] via-[#a855f7] to-[#ff00ff] bg-clip-text text-transparent">
                ...
                >
                    <motion.div
                        ...
                        className="w-6 h-10 mx-auto rounded-full border-2 border-cyan-400/50 flex items-start justify-center p-2"
                    >
