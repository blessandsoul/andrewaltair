    ...
    return (
        <>
            ...
            <button
                ...
                className="lg:hidden fixed z-[90] p-3.5 bg-white rounded-full shadow-xl border border-purple-200 text-purple-600 hover:bg-purple-50 transition-all active:scale-95"
