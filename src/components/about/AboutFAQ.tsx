...
const faqs = [
    ...
    {
        question: "ატარებთ თუ არა ტრენინგებს კომპანიებისთვის?",
        answer: "რა თქმა უნდა. მაქვს კორპორატიული ტრენინგების პროგრამა, რომელიც მორგებულია თქვენი გუნდის საჭიროებებზე - დაწყებული AI-ს საფუძვლებიდან, დამთავრებული პროცესების ავტომატიზაციით."
    },
    {
