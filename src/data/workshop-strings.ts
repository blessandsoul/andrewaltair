...
export const STR = {
    ...
    broadcast: {
        ...
        computerMic: 'კომპიუტერის მიკროფონი', // RU: микрофон компьютера (звук с компа)
        phoneAudioHint: 'ტელეფონი იძლევა ვიდეოს, ხმა კომპიუტერის მიკროფონიდან', // RU: телефон даёт видео, звук с микрофона компьютера
    },
