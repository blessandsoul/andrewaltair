...
export const STR = {
    ...
    nameGate: {
        ...
        errGeneric: 'ვერ მოხერხდა — სცადეთ თავიდან',
    ...
    results: {
        ...
        shiftMoved: (n: number) => `დისკუსიამ გადააადგილა ${n} მონაწილე`,
    ...
    controls: {
        ...
        seedTitle: 'Demo: ფეიქ-პასუხები რეპეტიციისთვის',
    },

    remote: {
        title: 'პულტი',
        notes: 'ჩემი ნოუთები',
        pinListHeader: 'პასუხები — დააჭირეთ ვარსკვლავს ეკრანზე გასატანად',
        unpin: 'დამაგრების მოხსნა',
        openDisplay: 'ეკრანის გახსნა (გასაშეარებლად)',
