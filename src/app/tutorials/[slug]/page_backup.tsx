    ...
    return (
        <>
            ...
            <div className="min-h-screen bg-background pb-20">
                {/* Hero Section */}
                <div className="relative min-h-[60vh] min-h-[500px] w-full overflow-hidden flex flex-col">
                    ...
                    <div className="container mx-auto flex-grow relative z-10 flex flex-col justify-end pb-12 px-4 pt-32">
