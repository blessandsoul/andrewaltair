...
export const metadata: Metadata = {
  ...
  description: "AI ექსპერტი საქართველოში. ვეხმარები ბიზნესს ხელოვნური ინტელექტის დანერგვაში. ChatGPT 5.2, Claude 4.5, Grok 3, Gemini 3, Qwen, DeepSeek - ყველა ტოპ მოდელი. Vibe Coding: Cursor, VSCode, Windsurf, Antigravity, Claude Code. N8N ავტომატიზაცია და AI აგენტები.",
  keywords: [
    "AI Expert Georgia",
    "Andrew Altair",
