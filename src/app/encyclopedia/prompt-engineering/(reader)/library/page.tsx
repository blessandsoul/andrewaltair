...
export const metadata: Metadata = {
    title: 'Prompt Engineering სტატიები | Andrew Altair',
    description: 'Prompt Engineering სტატიების ბიბლიოთეკა. Chain-of-Thought, Few-Shot და მზა პრომპტები.',
};

export default function PromptEngineeringLibraryPage() {
    return (
