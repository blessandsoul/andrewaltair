...
import { TbSearch, TbLock } from 'react-icons/tb';
        ...
        <div className="space-y-4">
            ...
            <div className="relative mb-6">
                ...
                <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-white border border-gray-200 rounded-xl text-base text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500 shadow-sm"
                />
            </div>
                ...
                {filteredArticles.map((article) => {
                    ...
                    return (
                        <Link
                            ...
                            className="block bg-white p-4 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all active:scale-[0.98]"
                        >
