...
export default async function ServicesPage() {
    ...
    const serviceSchema = {
        ...
        hasOfferCatalog: {
            '@type': 'OfferCatalog',
            name: 'AI Services',
            itemListElement: servicesData.map((service: any) => ({
                '@type': 'Offer',
                itemOffered: {
                    '@type': 'Service',
                    name: service.title,
                ...
                priceCurrency: service.pricing?.currency || 'GEL'
            }))
        }
    }
    ...
    const faqSchema = {
        ...
        mainEntity: [
            {
                '@type': 'Question',
                name: 'რა ფორმატით მიმდინარეობს კონსულტაცია?',
                acceptedAnswer: {
                    '@type': 'Answer',
                    text: 'კონსულტაციები მიმდინარეობს Zoom ან Google Meet-ით. ასევე შესაძლებელია პირადი შეხვედრა თბილისში.'
                }
            },
            {
                '@type': 'Question',
                name: 'რამდენი დრო სჭირდება AI ავტომატიზაციის დანერგვას?',
                acceptedAnswer: {
                    '@type': 'Answer',
                    text: 'დამოკიდებულია პროექტის სირთულეზე. მარტივი ავტომატიზაციები შეიძლება დასრულდეს 1-2 კვირაში, ხოლო კომპლექსური - 1-2 თვეში.'
                }
            },
            {
                '@type': 'Question',
                name: 'არის უფასო კონსულტაცია?',
                acceptedAnswer: {
                    '@type': 'Answer',
                    text: 'დიახ, პირველი 15-წუთიანი საწყისი კონსულტაცია უფასოა.'
                }
            }
        ]
    }
